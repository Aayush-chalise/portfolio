...
const LandingPage = () => {
  return (
    <main className="min-h-screen bg-bg-color w-full flex justify-center sm:items-center items-start max-sm:pt-52  gap-4 sm:gap-10 xl:pt-32 ">
      <div className="w-full max-w-full sm:max-w-3xl xl:max-w-6xl lg:max-w-4xl dots-bg relative bg-[rgb(242,242,242)] rounded-2xl overflow-hidden flex items-center justify-center mx-2 sm:mx-auto px-3 py-8 sm:py-12">
